...
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| App                                                  | `expo` / `react-native` / `react`                                                                 | ~54.0 / 0.81.5 / 19.1 — SDK 54 because `react-native-google-mobile-ads@16.5` uses RN 0.80+ codegen types |
...
| `src/ads/settle.ts`             | the round-trip above                                                                                                                                                                                    |
...
| `src/paywall/open.ts`           | `getCurrentOfferingForPlacement('tab_locked')` → `RevenueCatUI.presentPaywall`                                                                                                                          |
